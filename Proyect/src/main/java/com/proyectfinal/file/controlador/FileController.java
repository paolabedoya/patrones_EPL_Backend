...
import com.proyectfinal.file.modelo.Decision;
import com.proyectfinal.file.modelo.FileModel;
...
public class FileController {
    ...
    public ResponseEntity<List<String>> uploadFiles(@RequestParam("files")MultipartFile[] files) {
        ...
        try {
           List<String> rutesName = new ArrayList<>();
            //rutesName.add(rutaSentencias+"Table.txt");
            //rutesName.add(rutaSentencias+"Sentences.txt");
            ...
            for (MultipartFile file : files) {
                fileService.save(file);
                    ...
                    rutesName= m.crearTablaParse (decisions);
            }
           // message = "Se subieron los archivos correctamente " + rutesName;
            return ResponseEntity.status(HttpStatus.OK).body(rutesName);
        } catch (Exception e) {
